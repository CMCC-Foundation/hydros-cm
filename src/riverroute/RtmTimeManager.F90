...
subroutine timemgr_setup( calendar_in, start_ymd_in, start_tod_in, ref_ymd_in, &
  ...
  character(len=*), parameter :: sub = 'hydros::set_timemgr_init'
...
subroutine timemgr_init( dtime_in )
  ...
  character(len=*), parameter :: sub = 'hydros::timemgr_init'
...
subroutine init_clock( start_date, ref_date, curr_date, stop_date )
  ...
  !
  character(len=*), parameter :: sub = 'hydros::init_clock'
  type(ESMF_TimeInterval) :: step_size       ! timestep size
  type(ESMF_Time) :: current     ! current date (from clock)
  integer :: yr, mon, day, tod   ! Year, month, day, and second as integers
  integer :: rc                  ! return code
...
function TimeSetymd( ymd, tod, desc )
  ...
  !
  character(len=*), parameter :: sub = 'hydros::TimeSetymd'
...
integer function TimeGetymd( date, tod )
  ...
  !
  character(len=*), parameter :: sub = 'hydros::TimeGetymd'
  integer :: yr, mon, day
  integer :: rc                          ! return code
  !
...
subroutine init_calendar( )
  ...
  ! Local variables
  !
  character(len=*), parameter :: sub = 'hydros::init_calendar'
...
subroutine timemgr_print()
  ...
  !---------------------------------------------------------------------------------
  character(len=*), parameter :: sub = 'hydros::timemgr_print'
  integer :: rc
  integer :: yr, mon, day
...
subroutine advance_timestep()
  ...
  character(len=*), parameter :: sub = 'hydros::advance_timestep'
  integer :: rc
...
subroutine get_clock( clock )
  ...
  character(len=*), parameter :: sub = 'hydros::get_clock'
...
integer function get_step_size()
  ...
  character(len=*), parameter :: sub = 'hydros::get_step_size'
  type(ESMF_TimeInterval) :: step_size       ! timestep size
  integer :: rc
...
integer function get_nstep()
  ...
  ! Return the timestep number.
   ...
   character(len=*), parameter :: sub = 'hydros::get_nstep'
   integer :: rc
   integer(ESMF_KIND_I8) :: step_no
...
subroutine get_curr_date(yr, mon, day, tod, offset)
  ...
  integer, intent(out) ::&
   ...
   character(len=*), parameter :: sub = 'hydros::get_curr_date'
   integer :: rc
   type(ESMF_Time) :: date
...
! Local variables
   character(len=*), parameter :: sub = 'hydros::get_prev_date'
   integer :: rc
   type(ESMF_Time) :: date
!-----------------------------------------------------------------------------------------
...
subroutine get_start_date(yr, mon, day, tod)
   ...
   character(len=*), parameter :: sub = 'hydros::get_start_date'
   integer :: rc
   type(ESMF_Time) :: date
...
! Local variables
   character(len=*), parameter :: sub = 'hydros::get_ref_date'
   integer :: rc
   type(ESMF_Time) :: date
!-----------------------------------------------------------------------------------------
...
! Local variables
   character(len=*), parameter :: sub = 'hydros::get_curr_time'
   integer :: rc
...
! Local variables
   character(len=*), parameter :: sub = 'hydros::get_prev_time'
   integer :: rc
...
logical function is_first_step()
  ...
  ! Return true on first step of initial run only.
   character(len=*), parameter :: sub = 'hydros::is_first_step'
   integer :: rc
   integer :: nstep
   integer(ESMF_KIND_I8) :: step_no
...
logical function is_last_step()
  ...
  ! Return true on last timestep.
   character(len=*), parameter :: sub = 'hydros::is_last_step'
...
subroutine timemgr_finalize( )
   ...
   integer                     :: rc    ! return code
   character(len=*), parameter :: sub = 'hydros::timemgr_finalize'
   !
